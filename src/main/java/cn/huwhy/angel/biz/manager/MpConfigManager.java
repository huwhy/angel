...
import cn.huwhy.wx.sdk.model.JsTicketSignature;
...
public class MpConfigManager {
    ...
    public JsTicketSignature getJsApiSignature(int id, String url) {
        ...
        try {
            ...
            MpConfig config = get(id);
            JsTicketSignature jsapiSignature = new JsTicketSignature();
